...
SEEDS = [1, 2, 3]
OUT_DIR = "results/multi_eval_v2_all"
os.makedirs(OUT_DIR, exist_ok=True)

MODEL_SETS = {
    "td3_v2_fixed":  ("td3", "results/multi_td3_seed_sweep_v2/seed{seed}/multi_td3_ep600_v2_seed{seed}_actor_weights_best.weights.h5"),
    "td3_v2_rand":   ("td3", "results/multi_td3_seed_sweep_randomized_v2/seed{seed}/multi_td3_ep600_randv2_seed{seed}_actor_weights_best.weights.h5"),
    "sac_v2_fixed":  ("sac", "results/multi_sac_seed_sweep_v2/seed{seed}/multi_sac_ep600_v2_seed{seed}_actor_weights_best.weights.h5"),
    "sac_v2_rand":   ("sac", "results/multi_sac_seed_sweep_randomized_v2/seed{seed}/multi_sac_ep600_randv2_seed{seed}_actor_weights_best.weights.h5"),
    "ppo_v2_fixed":  ("ppo", "results/multi_ppo_seed_sweep_v2/seed{seed}/multi_ppo_ep600_v2_seed{seed}_model_weights_best.weights.h5"),
    "ppo_v2_rand":   ("ppo", "results/multi_ppo_seed_sweep_randomized_v2/seed{seed}/multi_ppo_ep600_randv2_seed{seed}_model_weights_best.weights.h5"),
}
