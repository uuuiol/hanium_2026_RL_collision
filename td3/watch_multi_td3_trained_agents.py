"""
watch_multi_td3_trained_agents.py

multi_td3_train_logging.py로 학습한 TD3 정책을 불러와서 화면에 실시간으로 보여줍니다.
watch_multi_ddpg_trained_agents.py와 완전히 동일한 절차이고, actor 가중치 파일만 다릅니다
(TD3도 실행 시점엔 actor만 필요 - critic들은 학습에만 쓰임).
"""
import os
import sys
...
from common.ddpg_model import Actor

# ===== 설정 =====
WEIGHTS_PATH = "multi_td3_ep600_actor_weights_best.weights.h5"
N_AGENTS = 3
MAX_STEPS = 200
